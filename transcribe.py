...
def on_message(self, msg):
    ...
    if "results" in data:
       ...
       # print(data['results'][0]['alternatives'][0]['transcript'])
        ...
        z=data['results'][0]['alternatives'][0]['transcript']
...
def get_url():
    ...
    # instance=config.get('auth','instance_id')
    # instance_id = REGION_MAP[instance]
    return ""
...
def main():
    ...
    url = "wss://api.kr-seo.speech-to-text.watson.cloud.ibm.com/instances/5ee2a5eb-f035-418b-97b8-bfed9d187bb2/v1/recognize?model=en-US_BroadbandModel"
